    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="header">
      ...
      <tr>
        ...
        <td width="60%" align="center"><?php if($imgs){?>
					...
					<img src="./img/banner/img_<?=$imgs?>?<?=time()?>" alt="<?=$ban_name?>" title="<?=$ban_name?>" border="0"/>
                    <?php }?></td>
		...
		<a title="<?=admin::labelsSystem('logout')?>" href="<?=admin::labelsSystem('logout','link')?>"><img src="lib/buttons/logout.gif" alt="<?=admin::labelsSystem('logout')?>" width="21" height="21" border="0" /></a>
                    ...
                    <div id="userDat">
                    <a href="userEdit_1.php" class="link3" title="<?=admin::labelsSystem('myProfile');?>"><img width="30" src="<?=$domain?>/lib/pencil.png" alt="Cambiar Contrase&ntilde;a" title="Cambiar Contrase&ntilde;a" /></a><br />
		...
		$imgProfile = "profile/thumb_" . $usr_photo;
