...
if ($validFile && $FILES['error']==0)
	...
	classfile::uploadFile($FILES,PATH_ROOT . '/profile/',$fileName);
	// redimencionamos al mismo pero con extencion jpg en el mismo tamaño
	redimImgPercent(PATH_ROOT . "/profile/" . $fileName, PATH_ROOT . "/profile/". $nomIMG,100,100);
	// Redimencionamos el nuevo jpg por el ancho definido
	redimImgWH(PATH_ROOT . "/profile/" . $nomIMG, PATH_ROOT . "/profile/". $nomIMG2,60,100);
	// Redimencionamos el nuevo jpg por el ancho definido
	redimImgWidth(PATH_ROOT . "/profile/" . $nomIMG, PATH_ROOT . "/profile/". $nomIMG22,31,100);	
	// Redimencionamos el nuevo jpg por el ancho definido
	redimImgWidth(PATH_ROOT . "/profile/" . $nomIMG, PATH_ROOT . "/profile/". $nomIMG3,300,100);
