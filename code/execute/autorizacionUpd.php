...
admin::initialize('parametrizaciones','subastaAdd'); 
...
if ($FILES["name"] != '')
	...
	classfile::uploadFile($FILES,PATH_ROOT . '/img/subasta/',$fileName);
		...
		list($width, $height) = getimagesize($image1);
			...
			$mythumb->save( PATH_PUBLIC."/img/subasta/".$nomIMG3 ,100 );	
			...
			$mythumb->save( PATH_PUBLIC."/img/subasta/".$nomIMG22 ,100 );	
			}
			else
			{
			...
			$mythumb->save( PATH_PUBLIC."/img/subasta/".$nomIMG22 ,100 );	
                        ...
                        unlink(PATH_ROOT . '/img/subasta/'.$fileName);               
...
if ($FILES2["name"] != '')
	...
	classfile::uploadFile($FILES2,PATH_ROOT.'/docs/subasta/',$nomDOC);	
        copy(PATH_ROOT.'/docs/subasta/'.$nomDOC, PATH_PUBLIC.'/docs/subasta/'.$nomDOC);
