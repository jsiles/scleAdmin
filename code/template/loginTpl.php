...
?>
			<table width="98%" border="0" cellpadding="5" cellspacing="5" class="box">
                            <tr><td class="title">
                                    <b>Cuenta Bloqueada</b><br><br> <b>Hasta horas:</b> <?=admin::getSession("LOCK_TIME")?><br><br> espere e <a class="linkBold2" href="<?=PATH_DOMAIN?>/" title="ingresar">ingrese nuevamente</a>
                                </td></tr>
                        </table>
            <?php 
            }else{
            ?>
            	<table width="98%" border="0" cellpadding="5" cellspacing="5" class="box">
                            <tr><td class="title">
                                    <b>IP NO habilitado, cont&aacute;ctese con el administrador, e <a class="linkBold2" href="<?=PATH_DOMAIN?>/" title="ingresar">ingrese nuevamente</a>
                                </td></tr>
                        </table>
            <?php } ?>
        </td>
