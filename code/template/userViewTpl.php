...
<tr>
		  ...
		  <tr>
            ...
            <td width="84%">
			<?php
			$imgSavedroot1 = PATH_ROOT . "/profile/thumb_" . $regusers["usr_photo"];
			$imgSaveddomain1 = PATH_DOMAIN . "/profile/thumb_" . $regusers["usr_photo"];
			$imgSaveddomain2 = PATH_DOMAIN . "/profile/" . $regusers["usr_photo"];
