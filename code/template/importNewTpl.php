...
<form name="addImport" method="post" action="code/execute/importAdd.php" enctype="multipart/form-data">
...
<br />
      ...
      <div id="contentButton">
          ...
          <td width="41%" style="font-size:11px;">
		  		<?=admin::labels('or');?> <a href="importList.php?tipUid=<?=$tipUid?>" ><?=admin::labels('cancel');?></a> 
		  </td>
        </tr>
      </table></div>
      <br /><br />
