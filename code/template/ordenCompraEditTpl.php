  ...
  <tr>
	...
	<tr>
        ...
        <tr>
            ...
            <td width="20%" >
                <?php
			$docsSavedroot = PATH_ROOT."/oc/".$oc["orc_document"];
                        $extension = pathinfo($docsSavedroot, PATHINFO_EXTENSION);
                        //echo $solEdit["sol_doc"]."##";
			if (file_exists($docsSavedroot) && $oc["orc_document"]!=""){
                            switch ($extension){
                                case 'jpg':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/image.gif";
                                    break;
                                case 'png':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/image.gif";
                                    break;
                                case 'pdf':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/pdf.gif";
                                    break;
                                case 'xls':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/excel.gif";
                                    break;
                                case 'xlsx':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/excel.gif";
                                    break;
                                case 'doc':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/word.gif";
                                    break;
                                case 'docx':
                                    $imgSaved=PATH_DOMAIN."/lib/ext/word.gif";
                                    break;
                                ...
                                default :
                                    $imgSaved=PATH_DOMAIN."/lib/ext/doc-txt.png";
                                    break;
                            }
			...
			<tr>
				<td width="25%" rowspan="2" align="center" valign="middle" style="padding:4px;">
                                    <a target="blank" href="<?=PATH_DOMAIN."/oc/".$oc["orc_document"];?>"><img src="<?=$imgSaved?>?<?=time();?>" border="0" /></a>
                                </td>
